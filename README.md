...
### Usage
To use BlackmailJS, it's recommended to inject the script before any logics scripts 
of yours. This can be either inside the <head> element or before the closing tag of <body>.
```html
